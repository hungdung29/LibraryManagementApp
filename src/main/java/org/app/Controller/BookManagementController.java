    ...
    private void configBookManagementTable() {
	   ...
	   quantityColumn.setCellValueFactory(new Callback<TableColumn.CellDataFeatures,
		  ...
		  public ObservableValue call(TableColumn.CellDataFeatures cellDataFeatures) {
			 return new SimpleIntegerProperty(((Book) cellDataFeatures.getValue())
				    .getQuantity()).asObject();
		  }
	   });
	   quantityColumn.setCellFactory(TextFieldTableCell.forTableColumn(
			 new IntegerStringConverter()));
	   quantityColumn.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<Book,
			 Integer>>() {
		  @Override
